...
class NotificationService {
    ...
    func getNotificationServices(_ callBack: @escaping ([Notification]) -> Void) {
        let notifications = [Notification(content: "Cảm thấy hài lòng về thái độ tận tâm, tận lực khám chữa bệnh của các bác sỹ ở bệnh viện TW Cảm thấy hài lòng về thái độ tận tâm ...", coverUrl: "https://thumbor.forbes.com/thumbor/960x0/https%3A%2F%2Fspecials-images.forbesimg.com%2Fdam%2Fimageserve%2F42977075%2F960x0.jpg%3Ffit%3Dscale", readStatus: false, publishedAt: "28/02/2019 08:13:59"),
                         ...
                         Notification(content: "Cảm thấy hài lòng về thái độ tận tâm, tận lực khám chữa bệnh của các bác sỹ ở bệnh viện TW Cảm thấy hài lòng về thái độ tận tâm ...", coverUrl: "https://thumbor.forbes.com/thumbor/960x0/https%3A%2F%2Fspecials-images.forbesimg.com%2Fdam%2Fimageserve%2F42977075%2F960x0.jpg%3Ffit%3Dscale", readStatus: true, publishedAt: "01/03/2019 08:13:59"),
                         Notification(content: "Cảm thấy hài lòng về thái độ tận tâm, tận lực khám chữa bệnh của các bác sỹ ở bệnh viện TW Cảm thấy hài lòng về thái độ tận tâm ...", coverUrl: "https://thumbor.forbes.com/thumbor/960x0/https%3A%2F%2Fspecials-images.forbesimg.com%2Fdam%2Fimageserve%2F42977075%2F960x0.jpg%3Ffit%3Dscale", readStatus: true, publishedAt: "21/02/2018 13:13:59")]

...
extension UIView {
    ...
    func setGradientLayer(startColor: UIColor, endColor: UIColor, gradientDirection: GradientDirection, radius: CGFloat? = nil) {
        ...
        shape.lineWidth = 0.5
        shape.path = UIBezierPath(roundedRect: self.bounds, cornerRadius: radius ?? 0).cgPath
